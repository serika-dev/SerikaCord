      ...
      <div className="max-w-5xl mx-auto px-6 md:px-10 py-8 md:py-12 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10 pb-6 border-b border-white/[0.06]">
          <div>
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#8b5cf6]/80">Developer Portal</span>
            </div>
            ...
            <p className="text-xs md:text-sm text-[#949ba4] mt-1 font-medium max-w-xl">
              Develop powerful bots, manage rich activities, and integrate tools with SerikaCord's API.
            </p>
          </div>
          <button
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-32 gap-3">
            ...
            <p className="text-xs text-[#888] font-medium animate-pulse">Loading developer applications...</p>
          </div>
        ) : filtered.length === 0 ? (
          <div className="text-center py-20 rounded-2xl border border-white/[0.04] bg-white/[0.01] backdrop-blur-sm p-8 animate-fade-in">
            ...
            <p className="text-xs md:text-sm text-[#777] max-w-sm mx-auto mb-6 leading-relaxed">
              {apps.length === 0
                ? "Create your first application to gain access to bot users, oauth2 credentials, and activity SDK configurations."
                : "No applications matched your search terms. Try searching with another name."}
            </p>
            {apps.length === 0 && (
              <button
                onClick={() => setShowCreateModal(true)}
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/[0.04] mt-2">
                  <span className="text-[10px] font-semibold uppercase tracking-wider text-[#555] bg-white/[0.03] border border-white/[0.04] px-2.5 py-1 rounded-lg">
                    {app.serverCount !== undefined ? `${app.serverCount} Servers` : "0 Servers"}
                  </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-md bg-[#0d0d0e] border border-white/[0.08] rounded-2xl p-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-lg font-bold text-white">Create Application</h2>
                <p className="text-xs text-[#888]">Initialize a new developer client</p>
              </div>
            </div>

            <p className="text-xs text-[#888] mb-5 leading-relaxed">
              Give your new application a name. This name will represent your bot and presence activities across the platform. You can customize descriptions and avatars later.
            </p>

            <div className="space-y-4">
              <div>
                <label className="block text-[10px] uppercase font-bold tracking-wider text-[#555] mb-2">Name *</label>
                <input
                  type="text"
                  value={newAppName}
