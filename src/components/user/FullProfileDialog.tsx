...
export function FullProfileDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[900px] w-[900px] max-h-[680px] p-0 gap-0 bg-[#0c0c10] border-white/[0.06] overflow-hidden">
        <DialogTitle className="sr-only">{displayName}&apos;s Profile</DialogTitle>
        <div className="flex h-[680px]">
          {/* Left panel — profile summary */}
          <div className="w-[340px] shrink-0 overflow-y-auto" style={getProfileBackgroundStyle(user.customization)}>
            {/* Banner */}
