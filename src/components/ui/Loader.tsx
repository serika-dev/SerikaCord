  ...
  return (
    ...
    >
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="loaderGrad" x1="6" y1="4" x2="42" y2="44" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#a78bfa" />
            <stop offset="100%" stopColor="#8b5cf6" />
          </linearGradient>
        </defs>
        <rect width="48" height="48" rx="12" fill="#0a0a0a" />
        <rect x="0.75" y="0.75" width="46.5" height="46.5" rx="11.25" fill="none" stroke="#8b5cf6" strokeWidth="0.75" className="serika-loader-ring" />
        <g className="serika-loader-cat">
          ...
          <g className="serika-loader-ear-left">
            <path d="M12.5 18 Q10.5 8 12.5 4 Q19 8 23 15.5 Z" fill="url(#loaderGrad)" />
            <path d="M14.5 15.5 Q13.2 8.5 14.5 5.5 L20.8 14.5 Z" fill="#f9a8d4" opacity="0.9" />
          </g>
          <g className="serika-loader-ear-right">
            <path d="M25 15.5 Q29 8 35.5 4 Q37.5 8 35.5 18 Z" fill="url(#loaderGrad)" />
            <path d="M27 14.5 L33.5 5.5 Q34.8 8.5 33.5 15.5 Z" fill="#f9a8d4" opacity="0.9" />
          </g>
          <path d="M24 13 C32.8 13 38.5 18.8 38.5 27 C38.5 35 32.8 40.5 24 40.5 C15.2 40.5 9.5 35 9.5 27 C9.5 18.8 15.2 13 24 13 Z" fill="url(#loaderGrad)" />
          <path d="M15 39 L9.5 44 L20 40 Z" fill="url(#loaderGrad)" />
          ...
          <g className="serika-loader-eyes">
          ...
          <path d="M21.8 36 Q23.2 37.4 24 36.2 Q24.8 37.4 26.2 36" stroke="#3b0764" strokeWidth="1" fill="none" strokeLinecap="round" />
        </g>
      </svg>
    </div>
  );
