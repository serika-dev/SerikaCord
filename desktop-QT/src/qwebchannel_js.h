...
// Embedded qwebchannel.js from Qt6 source
// This is the QWebChannel client-side library that enables JS ↔ C++ communication
// Source: https://code.qt.io/qt/qtwebchannel.git/src/webchannel/qwebchannel.js
// License: LGPL-3.0-only OR GPL-2.0-only OR GPL-3.0-only

static const char *QWEBCHANNEL_JS = R"QWEBCHANNEL("use strict";
